...
sh ovs-ofctl add-flow  s4 in_port=3,nw_dst=10.6.1.1,actions=output=2
sh ovs-ofctl add-flow  s2 in_port=2,nw_dst=10.6.1.1,actions=output=1
sh ovs-ofctl add-flow  s1 in_port=2,nw_dst=10.6.1.1,actions=output=1