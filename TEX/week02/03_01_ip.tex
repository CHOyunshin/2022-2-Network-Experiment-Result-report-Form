...
% \newpage
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Problem 3-4
        ...
        \soln Since total length is 56 bytes long and the header is 20 bytes long, the length of payload is $56 - 20 = 36$ bytes
    %     \vspace{-4mm}  
        \begin{figure}[!h]\centering
        \hspace{15mm}  
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Problem 3-5
        ...
        \soln Since Flags More fragments bit = 0, this IP datagram hasn’t been fragmented.
    %     \vspace{-4mm}  
    %     \begin{figure}[!h]\centering
    %     \hspace{15mm}  
